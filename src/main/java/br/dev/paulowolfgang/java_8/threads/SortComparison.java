...
public class SortComparison
{
    public static void main(String[] args)
    {
        ...
        String percentege = NumberFormat.getPercentInstance().format((double) sortTime / parallelSortTime);
        System.out.printf("%nsort took %s more time than parallelSort%n", percentege);
    }
}
