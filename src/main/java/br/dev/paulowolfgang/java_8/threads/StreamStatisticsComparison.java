...
public class StreamStatisticsComparison
{
    public static void main(String[] args)
    {
        ...
        // Cria um array de valores long aleatórios
        long[] values = random.longs(10_000_000, 1, 1001).toArray();

        // Realiza os cálculos separadamente
        ...
        // Cronometra a operação de soma com um fluxo sequencial
        ...
        // Cronometra a operação de soma com um fluxo paralelo
