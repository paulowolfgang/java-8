...
public class StringCompare {
    public static void main(String[] args) {
        ...
        System.out.printf("%ns2.compareTo(s1) is %d", s1.compareTo(s1));
        System.out.printf("%ns1.compareTo(s1) is %d", s1.compareTo(s1));
        System.out.printf("%ns3.compareTo(s4) is %d", s1.compareTo(s4));
        System.out.printf("%ns4.compareTo(s3) is %d%n%n", s1.compareTo(s3));
